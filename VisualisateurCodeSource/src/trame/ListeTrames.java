...
public class ListeTrames {
    ...
    public static void menuHelp(){
        ...
        "Exemple :\n"+
        "\033[0;32mjava -jar Visualisateur.jar {fichier} -v\033[0m\n\n" +
        
        "-vv : affiche toutes les informations de la trame.\n" +
        "Exemple :\n" +
        "\033[0;32mjava -jar Visualisateur.jar {fichier} -vv\033[0m\n\n" +
         
        "-i  : permet d'afficher les trames possédant seulement les ip fournies (séparé d'une virgule).\n" +
        "Exemple :\n" +
        "\033[0;32mjava -jar Visualisateur.jar {fichier} -i 145.254.160.237,216.239.59.99\033[0m\n\n" +
        
        "-p  : permet d'afficher les trames possédant l'entête fournie (séparé d'une virgule).\n" +
        "Exemple :\n" +
        "\033[0;32mjava -jar Visualisateur.jar {fichier} -p tcp,http\033[0m\n\n" +
        
        "Evidemment toutes les options sont cumulables.\n" +
        "Exemple : \n" +
        "\033[0;32mjava -jar Visualisateur.jar {fichier} -v -i 145.254.160.237,216.239.59.99 -p tcp \033[0m" 
        );
    }
}
